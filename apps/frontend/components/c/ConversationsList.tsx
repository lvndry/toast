      ...
      <Box maxW="7xl" mx="auto">
        <HStack justify="space-between" mb={4}>
          ...
          <HStack>
            ...
            <Button size="sm" colorScheme="blue" onClick={onCreate}>
                ...
                <VStack align="stretch" spacing={3}>
                  <HStack justify="space-between">
                    ...
                    <HStack spacing={2}>
                      <Button
                        size="xs"
                        variant={c.pinned ? "solid" : "outline"}
                      ...
                      <Button
                        size="xs"
                        variant={c.archived ? "solid" : "outline"}
                  ...
                  <HStack spacing={3}>
                    <Button size="sm" onClick={() => onOpenConversation(c.id)}>
                      Open
                    </Button>
                    <Button
                      size="sm"
